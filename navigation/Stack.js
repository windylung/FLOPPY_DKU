...
const ScreenMain = ({ navigation: { navigate } }) => {
  ...
  console.log(ScreenHEIGHT(844));
  return (
    <View>
      {/* top bar */}
      <View style={{ height: ScreenHEIGHT(101), backgroundColor: COLOR_ORANGE }}>
        <Image
          source={require("../logo_orange.png")}
          style={{ height: ScreenHEIGHT(36) }}
        />
      </View>
      ...
      <View>
        ...
        <TouchableOpacity>
          <Text>플랜 구독/관리</Text>
          <Text>꽃다발 주문 플랜 구독</Text>
        </TouchableOpacity>

        <TouchableOpacity>
          <Text>FLOPPY 이야기</Text>
          <Text>FLOPPY의 소식</Text>
        </TouchableOpacity>
      </View>
